# Error 0Z002: stacked_diagnostics_accessed_without_active_handler - Analysis and Solution

## 现象描述

当你在使用 PostgreSQL 时遇到这个错误，通常意味着 stacked_diagnostics_accessed_without_active_handler。
